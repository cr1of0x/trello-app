...
export const LIST_MOVE = "/list/move-list";
...
export const CARD_MOVE_ALL = "/card/move-all-cards-in-another-list";
export const CARD_DRAG_AND_DROP = "/card/move-card-in-another-list";
export const CARD_DND_SAME_LIST = "/card/move-card-on-card-in-same-list";
export const CARD_DND_ANOTHER_LIST = "/card/move-card-on-card-in-another-list";
